    ...
    <main className="min-h-screen flex flex-col bg-background overflow-x-hidden">
      ...
      <section className="w-full flex-1 flex flex-col items-center justify-center text-center px-4 py-20 md:py-28 lg:py-36">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold text-foreground mb-6 leading-tight tracking-tighter">
      ...
      <section className="bg-muted/30 w-full py-20">
        <div className="container mx-auto px-6 max-w-6xl">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground mt-2 text-lg">Centraliza tu vida académica en un solo lugar.</p>
            </div>
...
function FeatureCard({ icon, title, description }: {
  ...
  return (
    <div className="bg-background/30 border border-border/50 rounded-xl p-6 flex flex-col text-left transition-all duration-300 hover:border-primary/50 hover:bg-background">
